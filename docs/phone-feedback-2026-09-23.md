...
[Preuves et empreintes des journaux](../tests/deployment/phone-feedback-evidence-2026-09-23.json). Résultat CI reçu après ce relevé : backend, Android et iOS non signé réussis. Les parcours des trois rôles passent ; le contrôle de redémarrage échoue sur un ancien libellé de champ dans le harnais. Sa correction et sa nouvelle validation figurent dans [le suivi 1.1.2](chart-settings-2026-09-23.md). Les essais de laboratoire ne remplacent pas la qualification physique des performances ni celle d’iOS.
